                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start mb-3">
                            <img src="{{ Vite::asset('resources/images/users/user-1.jpg') }}" class="me-2 rounded-circle"
                                ...
                                <div data-simplebar style="max-height: 375px;">
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start p-2">
                                            <img src="{{ Vite::asset('resources/images/users/user-2.jpg') }}"
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start p-2">
                                            <img src="{{ Vite::asset('resources/images/users/user-5.jpg') }}"
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start p-2">
                                            <img src="{{ Vite::asset('resources/images/users/user-7.jpg') }}"
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start bg-light p-2">
                                            <img src="{{ Vite::asset('resources/images/users/user-10.jpg') }}"
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start p-2">
                                            <img src="{{ Vite::asset('resources/images/users/user-3.jpg') }}"
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start p-2">
                                            <img src="{{ Vite::asset('resources/images/users/user-6.jpg') }}"
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start p-2">
                                            <img src="{{ Vite::asset('resources/images/users/user-8.jpg') }}"
                                    ...
                                    <a href="javascript:void(0);" class="text-body">
                                        <div class="d-flex align-items-start p-2">
                                            <img src="{{ Vite::asset('resources/images/users/user-4.jpg') }}"
                        ...
                        <div class="row justify-content-between py-1">
                            <div class="col-sm-7">
                                <div class="d-flex align-items-start">
                                    <img src="{{ Vite::asset('resources/images/users/user-5.jpg') }}" class="me-2 rounded-circle"
                        ...
                        <ul class="conversation-list" data-simplebar style="max-height: 460px;">
                            <li class="clearfix">
                                <div class="chat-avatar">
                                    <img src="{{ Vite::asset('resources/images/users/user-5.jpg') }}" class="rounded"
                                        alt="James Z" />
                                    <i>10:00</i>
                                </div>
                            ...
                            <li class="clearfix odd">
                                <div class="chat-avatar">
                                    <img src="{{ Vite::asset('resources/images/users/user-1.jpg') }}" class="rounded"
                                        alt="Geneva M" />
                                    <i>10:01</i>
                                </div>
                                <div class="conversation-text">
                            ...
                            <li class="clearfix">
                                <div class="chat-avatar">
                                    <img src="{{ Vite::asset('resources/images/users/user-5.jpg') }}" alt="James Z"
                                        class="rounded" />
                                    <i>10:02</i>
                                </div>
                                <div class="conversation-text">
                            ...
                            <li class="clearfix odd">
                                <div class="chat-avatar">
                                    <img src="{{ Vite::asset('resources/images/users/user-1.jpg') }}" alt="Geneva M"
                                        class="rounded" />
                                    <i>10:03</i>
                                </div>
                                <div class="conversation-text">
