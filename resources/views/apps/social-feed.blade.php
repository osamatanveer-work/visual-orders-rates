        ...
        <div class="row">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="d-flex align-items-start">
                            <img class="d-flex align-items-start rounded me-2" src="{{ Vite::asset('resources/images/users/user-1.jpg') }}" alt="Dominic Keller" height="48">
            ...
            <div class="col-xl-6 col-lg-12 order-lg-2 order-xl-1">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-start">
                            <img class="me-2 avatar-sm rounded-circle" src="{{ Vite::asset('resources/images/users/user-3.jpg') }}" alt="Generic placeholder image">
                            <div class="w-100">
                        ...
                        <div class="row">
                            <div class="col-sm-8">
                                <img src="{{ Vite::asset('resources/images/small/img-4.jpg') }}" alt="post-img" class="rounded me-1 mb-3 mb-sm-0 img-fluid">
                            </div>
                            <div class="col">
                                <img src="{{ Vite::asset('resources/images/small/img-1.jpg') }}" alt="post-img" class="rounded me-1 img-fluid mb-3">
                                <img src="{{ Vite::asset('resources/images/small/img-3.jpg') }}" alt="post-img" class="rounded me-1 img-fluid">
                            </div>
                        </div>
                        ...
                        <div class="d-flex align-items-start mt-3">
                            <img src="{{ Vite::asset('resources/images/users/user-1.jpg') }}" height="32" class="align-self-start rounded me-2" alt="Arya Stark">
                            <div class="w-100">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-start">
                            <img class="me-2 avatar-sm rounded-circle" src="{{ Vite::asset('resources/images/users/user-4.jpg') }}" alt="Generic placeholder image">
                            <div class="w-100">
                                <div class="dropdown float-end text-muted">
                                    <a href="#" class="dropdown-toggle text-muted font-18" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="mdi mdi-dots-horizontal"></i>
                        ...
                        <div class="post-user-comment-box mt-2">
                            <div class="d-flex align-items-start">
                                ...
                                <div class="w-100">
                                    ...
                                    <div class="d-flex align-items-start mt-3">
                                        <a class="pe-2" href="#">
                                            <img src="{{ Vite::asset('resources/images/users/user-4.jpg') }}" class="avatar-sm rounded-circle" alt="Generic placeholder image">
                                        </a>
                                        <div class="w-100">
                            ...
                            <div class="d-flex align-items-start mt-2">
                                <a class="pe-2" href="#">
                                    <img src="{{ Vite::asset('resources/images/users/user-1.jpg') }}" class="rounded-circle" alt="Generic placeholder image" height="31">
                                </a>
                                <div class="w-100">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="d-flex align-items-start">
                            <img class="me-2 avatar-sm rounded-circle" src="{{ Vite::asset('resources/images/users/user-6.jpg') }}" alt="Generic placeholder image">
                            <div class="w-100">
                                <div class="dropdown float-end text-muted">
                                    <a href="#" class="dropdown-toggle text-muted font-18" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="mdi mdi-dots-horizontal"></i>
                    ...
                    <div class="card-body pb-0">
                        ...
                        <div class="inbox-widget">
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{ Vite::asset('resources/images/users/user-2.jpg') }}" class="rounded-circle" alt=""></div>
                            ...
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{ Vite::asset('resources/images/users/user-3.jpg') }}" class="rounded-circle" alt=""></div>
                            ...
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{ Vite::asset('resources/images/users/user-4.jpg') }}" class="rounded-circle" alt=""></div>
                            ...
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{ Vite::asset('resources/images/users/user-5.jpg') }}" class="rounded-circle" alt=""></div>
                            ...
                            <div class="inbox-item">
                                <div class="inbox-item-img"><img src="{{ Vite::asset('resources/images/users/user-6.jpg') }}" class="rounded-circle" alt=""></div>
