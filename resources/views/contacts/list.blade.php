        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="text-center card">
                    <div class="card-body">
                        <div class="pt-2 pb-2">
                            <img src="{{ Vite::asset('resources/images/users/user-3.jpg') }}" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">
            ...
            <div class="col-lg-4">
                <div class="text-center card">
                    <div class="card-body">
                        <div class="pt-2 pb-2">
                            <img src="{{ Vite::asset('resources/images/users/user-4.jpg') }}" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">
            ...
            <div class="col-lg-4">
                <div class="text-center card">
                    <div class="card-body">
                        <div class="pt-2 pb-2">
                            <img src="{{ Vite::asset('resources/images/users/user-5.jpg') }}" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="text-center card">
                    <div class="card-body">
                        <div class="pt-2 pb-2">
                            <img src="{{ Vite::asset('resources/images/users/user-6.jpg') }}" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">
            ...
            <div class="col-lg-4">
                <div class="text-center card">
                    <div class="card-body">
                        <div class="pt-2 pb-2">
                            <img src="{{ Vite::asset('resources/images/users/user-7.jpg') }}" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">
            ...
            <div class="col-lg-4">
                <div class="text-center card">
                    <div class="card-body">
                        <div class="pt-2 pb-2">
                            <img src="{{ Vite::asset('resources/images/users/user-8.jpg') }}" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">
        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="text-center card">
                    <div class="card-body">
                        <div class="pt-2 pb-2">
                            <img src="{{ Vite::asset('resources/images/users/user-2.jpg') }}" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">
            ...
            <div class="col-lg-4">
                <div class="text-center card">
                    <div class="card-body">
                        <div class="pt-2 pb-2">
                            <img src="{{ Vite::asset('resources/images/users/user-9.jpg') }}" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">
            ...
            <div class="col-lg-4">
                <div class="text-center card">
                    <div class="card-body">
                        <div class="pt-2 pb-2">
                            <img src="{{ Vite::asset('resources/images/users/user-10.jpg') }}" class="rounded-circle img-thumbnail avatar-xl" alt="profile-image">
