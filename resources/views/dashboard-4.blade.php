                ...
                <div class="widget-rounded-circle card bg-blue">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="avatar-lg">
                                    <img src="{{ Vite::asset('resources/images/users/user-6.jpg') }}" class="img-fluid rounded-circle img-thumbnail" alt="user-img">
                                </div>
                            </div>
                            <div class="col">
                                            ...
                                            <td>
                                                <div class="avatar-group">
                                                    ...
                                                    <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme">
                                                        <img src="{{ Vite::asset('resources/images/users/user-4.jpg') }}" class="rounded-circle avatar-xs" alt="friend">
                                                    </a>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="avatar-group">
                                                    ...
                                                    <a href="javascript: void(0);" class="avatar-group-item" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme">
                                                        <img src="{{ Vite::asset('resources/images/users/user-6.jpg') }}" class="rounded-circle avatar-xs" alt="friend">
                                                    </a>
