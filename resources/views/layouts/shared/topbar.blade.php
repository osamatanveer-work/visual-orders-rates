        ...
        <div class="topbar-menu d-flex align-items-center gap-1">
            ...
            <div class="logo-box">
                <a href="#" class="logo-light">
                    {{-- <img src="{{ Vite::asset('assets/logo4.png') }}" alt="logo" class="logo-lg">
                    <img src="{{ Vite::asset('assets/logo4.png') }}" alt="small logo" class="logo-sm"> --}}
                    <h5>Rate Shooper</h5>
                </a>
                <a href="#" class="logo-dark">
                    {{-- <img src="{{ Vite::asset('assets/logo4.png') }}" alt="dark logo" class="logo-lg">
                    <img src="{{ Vite::asset('assets/logo4.png') }}" alt="small logo" class="logo-sm"> --}}
                    <h5>Rate Shooper</h5>
        ...
        <ul class="topbar-menu d-flex align-items-center">
            ...
            <li class="dropdown">
                <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRhtMRbtowke9ZnnGtyYJmIuJaB2Q1y5I-3IA&s" alt="user-image" class="rounded-circle">
