    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        <form action="{{ route('company.store') }}" method="post" enctype="multipart/form-data"  id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
                            @csrf
                            <div class="row">
                            <div class="col-xl-6">
                                <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="company_url" class="form-control" placeholder="Enter company url">
                                    @error('company_url')
                                        <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3 border-bottom pb-4">
                                    ...
                                    <textarea class="form-control" name="description" id="company-overview" rows="5" placeholder="Enter some brief about company.."></textarea>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-12">
                                        <!-- Date View -->
                                        <div class="mb-3">
                                            <label class="form-label">Api Secreat Key<span class="text-danger">*</span></label>
                                            <input type="text" class="form-control"  name="api_secreat_key" placeholder="Enter api secreat key">
                                            @error('api_secreat_key')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        </div>
                                    </div>
                                ...
                                <div class="mb-3">
                                    <label for="api-token" class="form-label">Api Access Token<span class="text-danger">*</span></label>
                                    <input type="text" id="api-token" name="access_token" class="form-control" placeholder="Enter api access token">
                                    @error('access_token')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                </div>
