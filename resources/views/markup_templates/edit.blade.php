                        ...
                        <form action="{{ route('company.update',['id'=>$data->id]) }}" method="post" enctype="multipart/form-data"  id="myAwesomeDropzone" data-plugin="dropzone" data-previews-container="#file-previews" data-upload-preview-template="#uploadPreviewTemplate">
                            ...
                            <div class="col-xl-6">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control"  name="api_key" value="{{ $data->api_key }}" placeholder="Enter api key">
                                            @error('api_key')
                                            <span class="text-danger">{{ $message }}</span>
                                        @enderror
                                        </div>
                                    ...
                                    <div class="col-lg-12">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" value="{{ $data->api_secreat_key }}"  name="api_secreat_key" placeholder="Enter api secreat key">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" id="api-token" name="access_token" value="{{ $data->api_access_token }}" class="form-control" placeholder="Enter api access token">
                                    @error('access_token')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                                </div>
