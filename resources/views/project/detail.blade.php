                    ...
                    <div class="card-body">
                        ...
                        <div id="tooltips-container">
                            ...
                            <a href="javascript:void(0);" data-bs-container="#tooltips-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme" class="d-inline-block">
                                <img src="{{ Vite::asset('resources/images/users/user-6.jpg') }}" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                            </a>
                            ...
                            <a href="javascript:void(0);" data-bs-container="#tooltips-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty" class="d-inline-block">
                                <img src="{{ Vite::asset('resources/images/users/user-7.jpg') }}" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                            </a>
                            ...
                            <a href="javascript:void(0);" data-bs-container="#tooltips-container" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson" class="d-inline-block">
                                <img src="{{ Vite::asset('resources/images/users/user-8.jpg') }}" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                            </a>

                            <a href="javascript:void(0);" data-bs-container="#tooltips-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Mat Helme" class="d-inline-block">
                                <img src="{{ Vite::asset('resources/images/users/user-4.jpg') }}" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                            </a>

                            <a href="javascript:void(0);" data-bs-container="#tooltips-container" data-bs-toggle="tooltip" data-bs-placement="top" title="Michael Zenaty" class="d-inline-block">
                                <img src="{{ Vite::asset('resources/images/users/user-5.jpg') }}" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                            </a>

                            <a href="javascript:void(0);" data-bs-container="#tooltips-container" data-bs-toggle="tooltip" data-bs-placement="top" title="James Anderson" class="d-inline-block">
                                <img src="{{ Vite::asset('resources/images/users/user-3.jpg') }}" class="rounded-circle img-thumbnail avatar-sm" alt="friend">
                            </a>
                        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <div class="mt-2">
                            ...
                            <div class="d-flex align-items-start mt-3">
                                <img class="me-2 avatar-sm rounded-circle" src="{{ Vite::asset('resources/images/users/user-2.jpg') }}" alt="Generic placeholder image">
                                <div class="w-100">
