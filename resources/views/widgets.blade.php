                ...
                <div class="widget-rounded-circle card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="avatar-lg">
                                    <img src="{{ Vite::asset('resources/images/users/user-3.jpg') }}" class="img-fluid rounded-circle" alt="user-img" />
                                </div>
                            </div>
                            <div class="col">
                ...
                <div class="widget-rounded-circle card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="avatar-lg">
                                    <img src="{{ Vite::asset('resources/images/users/user-4.jpg') }}" class="img-fluid rounded-circle" alt="user-img" />
                                </div>
                            </div>
                            <div class="col">
                ...
                <div class="widget-rounded-circle card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="avatar-lg">
                                    <img src="{{ Vite::asset('resources/images/users/user-5.jpg') }}" class="img-fluid rounded-circle" alt="user-img" />
                                </div>
                            </div>
                            <div class="col">
                ...
                <div class="widget-rounded-circle card">
                    <div class="card-body">
                        <div class="row align-items-center">
                            <div class="col-auto">
                                <div class="avatar-lg">
                                    <img src="{{ Vite::asset('resources/images/users/user-6.jpg') }}" class="img-fluid rounded-circle" alt="user-img" />
                                </div>
                            </div>
                            <div class="col">
                                ...
                                <ul class="conversation-list">
                                    <li class="clearfix">
                                        <div class="chat-avatar">
                                            <img src="{{ Vite::asset('resources/images/users/user-5.jpg') }}" alt="male">
                                            <i>10:00</i>
                                        </div>
                                    ...
                                    <li class="clearfix odd">
                                        <div class="chat-avatar">
                                            <img src="{{ Vite::asset('resources/images/users/user-1.jpg') }}" alt="Female">
                                            <i>10:01</i>
                                        </div>
                                        <div class="conversation-text">
                                            <div class="ctext-wrap">
                                    ...
                                    <li class="clearfix odd">
                                        <div class="chat-avatar">
                                            <img src="{{ Vite::asset('resources/images/users/user-1.jpg') }}" alt="male">
                                            <i>10:02</i>
                                        </div>
                                        <div class="conversation-text">
                                            <div class="ctext-wrap">
